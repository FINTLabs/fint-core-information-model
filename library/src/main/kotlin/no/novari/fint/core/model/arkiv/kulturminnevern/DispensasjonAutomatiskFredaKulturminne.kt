...
data class DispensasjonAutomatiskFredaKulturminne(
    var kulturminneId: String? = null,
    var matrikkelnummer: Matrikkelnummer? = null,
    ...
    override fun visitIdentifikators(visitor: IdentifikatorVisitor) {
        ...
        visitor.visit("soknadsnummer", soknadsnummer)
    }
    ...
    companion object Metadata : FintResourceMetadata {
        ...
        override val attributes = listOf(
            ...
            FintAttribute("matrikkelnummer", Matrikkelnummer::class, list = false, optional = false),
            FintAttribute("soknadsnummer", Identifikator::class, list = false, optional = false),
            FintAttribute("tiltak", String::class, list = false, optional = true),
