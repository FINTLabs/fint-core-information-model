...
data class Halvarsfagvurdering(
    ...
    companion object Metadata : FintResourceMetadata {
        override val type = Halvarsfagvurdering::class
        override val ref = "utdanning-vurdering:Halvarsfagvurdering"
        override val path = "utdanning/vurdering/halvarsfagvurdering"
        override val name = "halvarsfagvurdering"
        ...
        override val relations = listOf(
            FintRelation(
                ...
                bidirectional = Bidirectional(inverseName = "halvarsfagvurdering", isSource = false, inverseMultiplicity = FintMultiplicity.ZERO_OR_MORE),
            ),
            FintRelation(
                name = "fag",
                target = Fag::class,
