    ...
    companion object Metadata : FintResourceMetadata {
        ...
        override val relations = listOf(
            FintRelation(
                ...
                bidirectional = Bidirectional(inverseName = "persongruppemedlemskap", isSource = true, inverseMultiplicity = FintMultiplicity.ZERO_OR_MORE),
            ),
            FintRelation(
                name = "persongruppe",
                target = Persongruppe::class,
                targetPath = "utdanning/elev/persongruppe",
                multiplicity = FintMultiplicity.EXACTLY_ONE,
                bidirectional = Bidirectional(inverseName = "persongruppemedlemskap", isSource = false, inverseMultiplicity = FintMultiplicity.ZERO_OR_MORE),
            ),
        )
    }
}
