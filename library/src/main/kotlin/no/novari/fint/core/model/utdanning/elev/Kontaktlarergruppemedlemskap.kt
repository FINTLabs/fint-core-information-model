...
data class Kontaktlarergruppemedlemskap(
    ...
    companion object Metadata : FintResourceMetadata {
        ...
        override val relations = listOf(
            FintRelation(
                ...
                bidirectional = Bidirectional(inverseName = "kontaktlarergruppemedlemskap", isSource = true, inverseMultiplicity = FintMultiplicity.ZERO_OR_MORE),
            ),
            FintRelation(
