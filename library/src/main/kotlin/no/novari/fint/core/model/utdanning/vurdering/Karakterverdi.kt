...
import no.novari.fint.core.model.utdanning.kodeverk.Karakterskala

data class Karakterverdi(
    ...
    companion object Metadata : FintResourceMetadata {
        ...
        override val relations = listOf(
            FintRelation(
                name = "skala",
                target = Karakterskala::class,
                targetPath = "utdanning/kodeverk/karakterskala",
                multiplicity = FintMultiplicity.EXACTLY_ONE,
                bidirectional = Bidirectional(inverseName = "verdi", isSource = true, inverseMultiplicity = FintMultiplicity.ZERO_OR_MORE),
            ),
        )
    }
}
