...
data class Variabellonn(
    ...
    companion object Metadata : FintResourceMetadata {
        ...
        override val attributes = listOf(
            ...
            FintAttribute("belop", Long::class, list = false, optional = true),
        ...
        override val relations = listOf(
            ...
            FintRelation(
                ...
                multiplicity = FintMultiplicity.EXACTLY_ONE,
                bidirectional = Bidirectional(inverseName = "variabellonn", isSource = true, inverseMultiplicity = FintMultiplicity.ZERO_OR_MORE),
            ),
            FintRelation(
                name = "anviser",
