...
data class Karakterskala(
    ...
    companion object Metadata : FintResourceMetadata {
        override val type = Karakterskala::class
        override val ref = "utdanning-kodeverk:Karakterskala"
        override val path = "utdanning/kodeverk/karakterskala"
        override val name = "karakterskala"
        ...
        override val relations = listOf(
            ...
            FintRelation(
                ...
                bidirectional = Bidirectional(inverseName = "skala", isSource = false, inverseMultiplicity = FintMultiplicity.EXACTLY_ONE),
            ),
        )
    }
}
